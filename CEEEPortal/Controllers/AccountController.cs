...
namespace CEEEPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            //}
            if (string.IsNullOrEmpty(returnUrl)) returnUrl = "/Employer/Index";
            if (string.IsNullOrEmpty(returnUrl)) returnUrl = Request.UrlReferrer != null ? Request.UrlReferrer.LocalPath : "/Home/Index";
