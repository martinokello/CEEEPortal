                ...
                try
                {
                    using (var dbContext = new ProNetTestEntities())
                    {
                        ...
                        job.EmploymentTypeId = graduateOrStudentJob.ContractType == ContractType.Permanent
                                                   ...
                                                   : graduateOrStudentJob.ContractType == ContractType.Fixed
                                                         ? 5
                                                         : graduateOrStudentJob.ContractType ==
                                                           ContractType.CasualZeroHour
                                                               ? 9
                                                               : 10;
                        jobDescription.IsVolunteering = false;
                ...
                try
                {
                    ...
                    if (fileNames != null && fileNames.Count > 0)
                        for (int i = 0; i < fileNames.Count; i++)
                        {
                            ...
                            SaveJobDocumentByJobId(job.JobId, fileBytes[i],
                                                   fileNames[i].Substring(fileNames[i].LastIndexOf(".")), fileNames[i]);
                        }
                }
                catch (DbEntityValidationException ex)
                {
                    ...
                    using (var dbContext = new ProNetTestEntities())
                    {
                        ...
                        if (fileNames != null && fileNames.Count > 0)
                            for (int i = 0; i < fileNames.Count; i++)
                            {
                                ...
                                UpdatejobDocumentByJobId(job.JobId, fileBytes[i],
            ...
            using (var transactScope = new TransactionScope())
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(oneDayChallengeCharityJob.BudgetFormFileName))
                        SaveJobDocumentByJobId(job.JobId, oneDayChallengeCharityJob.BudgetFormFile,
                    ...
                    if (!string.IsNullOrEmpty(oneDayChallengeCharityJob.RiskAssesmentFormFileName))
                        SaveJobDocumentByJobId(job.JobId, oneDayChallengeCharityJob.RiskAssesmentFormFile,
                                               oneDayChallengeCharityJob.RiskAssesmentFormFileName.Substring(
                                                   oneDayChallengeCharityJob.RiskAssesmentFormFileName.LastIndexOf(".")),
                                               oneDayChallengeCharityJob.RiskAssesmentFormFileName);
                    //SaveFiles:
                    if (!string.IsNullOrEmpty(oneDayChallengeCharityJob.SessionPlanFileName))
                        SaveJobDocumentByJobId(job.JobId, oneDayChallengeCharityJob.SessionPlanFile,
            ...
            using (var transactScope = new TransactionScope())
            {
                try
                {
                    ...
                    placementInternationalVol.HasCarriedOutRiskAssesment =
                        !string.IsNullOrEmpty(volunteeringPlacementJob.HasCarriedOutRiskAssesment)
                            ? true
                            : false;
                    ...
                    placementInternationalVol.HowToPostApplication =
                        volunteeringPlacementJob.ApplicationReceiveEmail + "," +
                    ...
                    placementInternationalVol.ApplicationMethod =
                        volunteeringPlacementJob.ApplicationMethodCoverLetter + "," +
                    ...
                    opportunityTypes += volunteeringPlacementJob.OpportunityCategoryType.EthnicityReligion +
                                        ",";
                    opportunityTypes +=
                        volunteeringPlacementJob.OpportunityCategoryType.EventProjectManagement + ",";
                    ...
                    opportunityTypes +=
                        volunteeringPlacementJob.OpportunityCategoryType.InternationalDevelopment + ",";
                    ...
                    using (var dbContext = new ProNetTestEntities())
                    {
                        placementInternationalVol.VolunteeringTypeID =
                            dbContext.CeeeVolunteeringTypes.SingleOrDefault(p => p.Name == volunteeringType)
                                     .VolunteeringTypeID;
                    ...
                    if (!string.IsNullOrEmpty(volunteeringPlacementJob.ApplicationFormFileName))
                        SaveJobDocumentByJobId(job.JobId, volunteeringPlacementJob.ApplicationFormFile,
                                               volunteeringPlacementJob.ApplicationFormFileName.Substring(
                                                   volunteeringPlacementJob.ApplicationFormFileName
                                                                           .LastIndexOf(".")),
                                               volunteeringPlacementJob.ApplicationFormFileName);

                    if (!string.IsNullOrEmpty(volunteeringPlacementJob.RoleDescriptionFileName))
                        SaveJobDocumentByJobId(job.JobId, volunteeringPlacementJob.RoleDescriptionFile,
                                               volunteeringPlacementJob.RoleDescriptionFileName.Substring(
            ...
            using (var transactScope = new TransactionScope())
            {
                ...
                try
                {
                    using (var dbContext = new ProNetTestEntities())
                    {
                        ...
                        //SaveFiles:
                        if (!string.IsNullOrEmpty(volunteeringPlacementJob.ApplicationFormFileName))
                            UpdatejobDocumentByJobId(job.JobId, volunteeringPlacementJob.ApplicationFormFile,
                                                     volunteeringPlacementJob.ApplicationFormFileName.Substring(
                                                         volunteeringPlacementJob.ApplicationFormFileName.LastIndexOf(
                                                             ".")),
                                                     volunteeringPlacementJob.ApplicationFormFileName);

                        if (!string.IsNullOrEmpty(volunteeringPlacementJob.RoleDescriptionFileName))
                            UpdatejobDocumentByJobId(job.JobId, volunteeringPlacementJob.RoleDescriptionFile,
                                                     volunteeringPlacementJob.RoleDescriptionFileName.Substring(
